...
public class DictBuilderTest extends TestCase{
    ...
    public void testExtractSentence() throws IOException{
        String d = "one two three";
        List<String> extract = TokenCollector.extractTokens(d);
        assertEquals(5, extract.size());
    }
    
    public void testDocFreqMap() throws IOException{
        String doc1 = "one two three";
        String doc2 = "two three four";
        TokenCollector dictionaryBuilder = new TokenCollector(2, 1);
    ...
    public void testBoundedSet() throws IOException{
        String doc1 = "one two three three three";
        String doc2 = "two three four";

        TokenCollector dictionaryBuilder = new TokenCollector(3, 1);
        dictionaryBuilder.addTokensToFreqMap(doc1);
        dictionaryBuilder.addTokensToFreqMap(doc2);
